...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if (isset($_GET['ID'])) echo '<li class="nav-item">';
    ...
    <div class="container py-4">
        <?php if (!isset($_GET['ID']) && article_count()) { ?>
            <div class="row">
                ...
                <div class="col-lg-12 py-3 mx-auto">
                    <?php
                    if ($page > 1) {
                        echo '<a href="pagination_edits.php?p=1" class="btn btn-outline-primary">&larr; Prev Page</a>';
                    }

                    if ($page != $lastpage) {
                        echo '<a href="pagination_edits.php?n=1" class="btn btn-outline-primary">Next Page &rarr;</a>';
                    }
                    ?>
                </div>
            </div>
            ...
            echo '<div class="row">
                    <div class="col-lg-12 py-2 mx-auto">
                        <div class="alert alert-info">
                            ...
                            Feel free to create your first one.
                        </div>
                    </div>
                  </div>';
        } elseif (isset($_GET['ID'])) {
            $articleId = intval($_GET['ID']);
            $ar = new Article($articleId);
        ?>
            <div class="row">
                <div class="col-lg-9 py-2 mx-auto">
                    <form action="edit.php?ID=<?php echo $articleId; ?>" method="POST">
                        <div class="form-group">
                        ...
                        if (isset($_GET['e'])) {
                            echo '<div class="form-group">
                                    <div class="alert alert-warning">
                                        ...
                                        Error - Unable to save changes, please check your database settings.
                                    </div>
                                  </div>';
                        } elseif (isset($_GET['s'])) {
                            echo '<div class="form-group">
                        ...
                        ?>
                        <div class="form-group">
                            <input type="text" value="<?php echo htmlentities($ar->title); ?>" class="form-control" required name="title" placeholder="Title">
                        </div>
                        <div class="form-group">
                            <input type="text" value="<?php echo htmlentities($ar->subtitle); ?>" class="form-control" required name="subtitle" placeholder="Subtitle">
                        </div>
                        <div class="form-group">
                            <textarea name="content" id="content" required class="form-control"><?php echo htmlentities($ar->content); ?></textarea>
                        </div>
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-outline-primary col-6" name="change">Save Changes</button>
                        </div>
                    </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-outline-danger" href="fulldelete.php?ID=<?php echo $articleId; ?>">Confirm Delete</a>
                </div>
            </div>
        </div>
    </div>
